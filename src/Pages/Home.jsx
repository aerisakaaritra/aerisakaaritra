...
import herpt2 from '../assets/herpt2.mp3'
...
const Home = () => {
  ...
  const audioRef = useRef(new Audio(herpt2))
  ...
  return (
    <section className='w-full h-screen relative'>
      ...
      <div className='absolute bottom-2 left-2'>
        <img src={!isPlayingMusic ? soundoff : soundon} alt="music" className='w-10 h-10 cursor-pointer object-contain' 
